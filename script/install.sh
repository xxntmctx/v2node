...
install_v2node() {
    ...
    if  [[ -z "$version_param" ]] ; then
        ...
        url="https://github.com/xxntmctx/v2node/releases/download/${last_version}/v2node-linux-${arch}.zip"
...
EOF
    ...
    curl -o /usr/bin/v2node -Ls https://raw.githubusercontent.com/xxntmctx/v2node/main/script/v2node.sh
